...
def torch_to_tensorrt_llm_checkpoint(
    ...
    for module in transformer_layers:
        ...
        elif is_medusa_head(module):
            medusa_heads = []
            for medusa_head in module.children():
                medusa_heads.append(
                    build_medusa_head_config(medusa_head, dtype)
                )
            config.medusa_heads = medusa_heads
