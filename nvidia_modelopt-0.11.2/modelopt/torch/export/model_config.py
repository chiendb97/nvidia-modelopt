...
@dataclass
class MedusaLayerConfig:
    """The medusa layer config."""
...
class ModelConfig:
    ...
    medusa_heads: List[MedusaHeadConfig] = field(default_factory=list)
    ...
    @property
    def num_medusa_layers(self):
        """Returns the hidden_act of the model."""
        return len(self.medusa_heads[0].medusa_layers)
